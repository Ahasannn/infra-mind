"""MoA (Mixture of Agents) baseline — MATH dataset."""
...
def parse_args():
    p = argparse.ArgumentParser(description="MoA baseline — MATH")
...
if __name__ == "__main__":
    ...
    for arrival_rate in arrival_rates:
        ...
        logger.info("MoA MATH rate={}: {}/{} ({:.1%})",
                     arrival_rate, total_solved, total_executed, accuracy)

    logger.info("MoA MATH complete.")
