...
SLURM_SCRIPT="scripts/baseline_train/math/train_mas_math.slurm"
...
echo "  tail -f logs/baseline_train/math/slurm-${JOB_ID}.out"
echo "  tail -f logs/baseline_train/math/slurm-${JOB_ID}.err"
echo ""
echo "Cancel job:"
echo "  scancel $JOB_ID"
echo ""
