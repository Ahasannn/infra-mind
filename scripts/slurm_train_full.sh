#!/bin/bash
#SBATCH --job-name=mas_train_full
...
#SBATCH --exclusive
#SBATCH --output=logs/slurm_train_full_%j.out
#SBATCH --error=logs/slurm_train_full_%j.err
...
# ==============================================================================
echo "============================================"
echo "[$(date)] STEP 3: Starting training..."
echo "============================================"
echo ""
...
bash scripts/mas_train_mbpp.sh 2>&1 | tee logs/train_full_${SLURM_JOB_ID}.log
